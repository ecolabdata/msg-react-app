...
export const investisseur : CardType = {
    ...
    color: "#68A532",
    title: "Investisseurs",
    description: "Investisseurs oublics et privés adaptés à votre maturité pour votre prochaine levée de fonds.",
    name: "investisseurs",
...
export const retex : CardType = {
    ...
    color: "#F95C5E",
    title: "Acteurs publics ouverts à l'innovation",
    description: "Collectivités ou organismes publics ayant eu des expériences avec des entreprises éco-innovantes",
    name: "retex",
...
export const achatProg : CardType = {
    ...
    description: "Achats programmés par les collectivités et organismes publics",
