                ...
                <div className="fr-container dsfr-lg:relative">
                    <div className="fr-footer__body">
                        ...
                        <div className="fr-footer__content">
                            <p className="fr-footer__content-desc">Mes services Greentech est en version beta. L’outil vous propose automatiquement des pistes pour booster votre développement ! Merci de nous aider à améliorer l’expérience en répondant à ce <a className="font-bold" href="#">formulaire.</a></p>
