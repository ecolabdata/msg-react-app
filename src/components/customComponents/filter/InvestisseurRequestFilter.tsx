...
import { AnyCard, Investisseur, InvestisseurQuery, searchInvestisseur } from '../../../api/Api';
      ...
      <>
        <div className="my-2 flex flex-col items-center lg:flex-row lg:mb-6">
          <div className="inputNumber mr-6 flex flex-col font-light ">
            <label className="mb-1 text-white text-base" htmlFor="montantKEuro">
              Montant min. en K€
            </label>
            <input
              className={`text-white rounded-t-md w-64 h-10 addBorder-b border-2 bg-input-background`}
              style={{ borderColor: this.cardType.color }}
              type="number"
              id="montantKEuro"
