export const LegalNotices = () => {
  return (
    <div className="mx-8 w-4/5">
      <h1 className="my-4 font-bold text-3xl">Mentions Légales</h1>
      ...
      <p>Equipe numérique : Matthieu Humbersot, Coralie Coton, Charlotte Samson, Alexis Brissard</p>
      <p>
      ...
      <p>
        ...
        C'est le cas notamment pour les discours et interventions des ministres et les communiqués.
        Les informations utilisées ne doivent l'être qu'à des fins personnelles, associatives ou
        professionnelles ; toute utilisation à des fins commerciales ou publicitaires est
      ...
      <p>
        respect de l'intégrité des documents reproduits (aucune modification, ni altération d'aucune
        sorte) ;
      </p>
      <p>
      ...
      <p>
        ...
        illustrations et des lexiques, ainsi que de l'ensemble des contenus éditoriaux produits pour
        l'animation éditoriale du site est conditionnée à l'accord de l'auteur. Le répertoire des
        informations publiques du ministère de la Transition écologique précise la charte de
      ...
      <p>
        ...
        les informations diffusées par le ministère de la Transition écologique. En revanche, les
        pages du site ne doivent pas être imbriquées à l’intérieur des pages d’un autre site.
      </p>
      <p>
        L’autorisation de mise en place d’un lien est valable pour tout support, à l’exception de
        ceux diffusant des informations à caractère polémique, pornographique, xénophobe ou pouvant,
      ...
      <p>
        ...
        contenus, les documents mis en ligne ne sauraient engager la responsabilité du ministère de
        la Transition écologique.
      </p>
      <p>
        Les informations et/ou documents disponibles sur ce site sont susceptibles d’être modifiés à
        tout moment, et peuvent faire l’objet de mises à jour.
      </p>
      <p>
        Le ministère de la Transition écologique ne pourra en aucun cas être tenu responsable de
        tout dommage de quelque nature qu’il soit résultant de l’interprétation ou de l’utilisation
      ...
      <p>
        Par conséquent, le ministère de la Transition écologique ne peut garantir une disponibilité
        du site et/ou des services, une fiabilité des transmissions et des performances en terme de
        temps de réponse ou de qualité. Il n’est prévu aucune assistance technique vis-à-vis de
        l’utilisateur que ce soit par des moyens électronique ou téléphonique. s
      </p>
      <p>
      ...
      <p>
        Le ministère de la Transition écologique peut être amené à interrompre le site ou une partie
        des services, à tout moment sans préavis, le tout sans droit à indemnités. L’utilisateur
        reconnaît et accepte que le ministère de la Transition écologique ne soit pas responsable
      ...
      <p>
        Quel que soit le lieu d’utilisation, le présent site est régi par le droit français. En cas
        de contestation éventuelle, et après l’échec de toute tentative de recherche d’une solution
