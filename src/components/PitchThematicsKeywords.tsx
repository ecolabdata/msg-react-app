...
export const PitchThematicsKeywords: React.FC<PitchThematicsKeywordsParams> = ({ usedDescription, usedSecteurs, usedMotsClef, usedInListPage, userFromHomePage }) => {
    ...
    const [openPitchContainer, setOpenPitchContainer] = useState(userFromHomePage);
    return (
        <div className={`${usedInListPage && 'addBorder border border-dark-text-action bg-background-form'}
        ${!openPitchContainer ?'h-10 justify-center items-center' : 'lg:h-[408px]'}
                ...
                ?
                    <>
                        ...
                        lg:w-1/2 '>
                            ...
                            <div className="projectContainer relative mt-8 h-fit w-[92%] flex flex-col justify-center
                            lg:mt-0">
